...
import { IconBrandFacebook, IconBrandInstagram, IconBrandTiktok, IconClick, IconLink, IconMail, IconPhone, IconWalk, IconWorld } from "@tabler/icons-react";
import 'animate.css';
...
const TourGuide = dynamic(() => import("@/components/TourGuide/CoachGuide"), { ssr: false });
